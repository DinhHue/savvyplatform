...
{
    public partial class ClaimMau : System.Web.UI.Page
    {
        ...
        void loadData()
        {
            ...
            if (dr != null)
            {
                ...
                //IR
                lblExecutiveSummaryHIR.Text = dr["ExecutiveSummaryIR"].ToString();
                txtExecutiveSummaryHIR.Text = dr["ExecutiveSummaryIR"].ToString();
