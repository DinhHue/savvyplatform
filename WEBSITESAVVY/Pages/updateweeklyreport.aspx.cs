...
{
    public partial class updateweeklyreport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if(Session["ThamChieu"]!="")
                {
                    //load_CK();
                    string maclaim = Session["ThamChieu"].ToString();
                    maWR = wrdao.LayMa(maclaim);
                    ...
                    {
                        //string idclaim = cldao.LayMaTheoTen(maclaim);
                        txtThamChieu.Visible = false;
                        lblThamChieu.Visible = true;
         ...
         void LoadWRChiTiet(int ma)
        {
            ...
            txtDeXuatGiamDinh.Text = dr[6].ToString();
