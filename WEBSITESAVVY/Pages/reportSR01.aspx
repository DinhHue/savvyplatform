                              ...
                              CssClass="label-edit align-right" ></asp:Label>
                                ...
                                <asp:Panel ID="panelNgayBatDauGiamDinh" Width="269px"  CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button21" title="Ngày thực hiện - SR01"  key="NgayBatDauGiamDinh" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            ...
                            <td class="style3" >
                                <asp:Label ID="lblTenClaim" runat="server" 
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button20" title="Tên Case - SR01" key="TenClaim" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                            ...
                            <td valign="top"  >
                                ...
                                <asp:Label ID="lblSR01GDV" runat="server" Text="GIAM DINH VIEN" 
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button24" title="GĐV thực hiện - SR01" key="SR01GDV" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            ...
                            <td valign="top" class="style2"><asp:Label ID="Label10" runat="server"
                                ...
                                <asp:Panel ID="panelPolicyNO" Width="269px"  CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button key="PolicyNO" title="Số HĐBH - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            ...
                            <td ><asp:Label ID="Label5" runat="server"
                                ...
                                <asp:Panel ID="panelEffective" Width="269px"  CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button key="Effective" title="Ngày hiệu lực HĐBH - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            <td colspan="2" class="style1" >
                                ...
                                <asp:Label ID="lblTenKhachHang" runat="server" key="TenKhachHang" 
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button14" title="Tên NĐBH - SR01" key="TenKhachHang" onclick="btnUpdateKhachHang_Click" Text="Update" runat="server"/>
                            ...
                            <td ><asp:Label ID="Label8" runat="server"
                                ...
                                <asp:Label ID="lblFax" runat="server" Text="Fax No." key="Fax" type="SingleLine" onclick="editField(this)"
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button15" title="Fax - SR01" key="Fax" onclick="btnUpdateKhachHang_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            <td colspan="3" >
                                ...
                                <asp:Label ID="lblDiaChi" runat="server" Width="811px" key="DiaChi" type="SingleLine" onclick="editField(this)"
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button16" title="Địa chỉ - SR01" key="DiaChi" onclick="btnUpdateKhachHang_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            <td colspan="3" >
                                ...
                                <asp:Label ID="lblTenNguoiDaiDien" runat="server"  key="TenNguoiDaiDien" type="SingleLine" onclick="editField(this)"
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button17" title="Người liên hệ - SR01" key="TenNguoiDaiDien" onclick="btnUpdateKhachHang_Click" Text="Update" runat="server"/>
                                ...
                                <asp:Label ID="lblDienThoai" runat="server" Text="PHONE " key="DienThoai" type="SingleLine" onclick="editField(this)"
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button18" title="Điện thoại - SR01" key="DienThoai" onclick="btnUpdateKhachHang_Click" Text="Update" runat="server"/>
                                ...
                                <asp:Label ID="lblEmail" runat="server" Text="EMAIL" key="Email"  type="SingleLine" onclick="editField(this)"
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button19" title="Email - SR01" key="Email" onclick="btnUpdateKhachHang_Click" Text="Update" runat="server"/>
                        ...
                        <tr>
                            <td colspan="3" style="text-align:center; "  >
                                <div class="bg_text" style="margin:3px 5px">
                                    <h2 style="padding-top:10px; padding-bottom:5px; margin:0"  >THÔNG TIN SƠ BỘ VỀ TỔN THẤT<br />
                                            <i>INITIAL INFORMATION OF LOSS / DAMAGE </i></h2>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td colspan="3" >
                                ...
                                <asp:Panel ID="panelPremises" Width="456px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button  key="Premises" title="Địa điểm tổn thất - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                                ...
                                <asp:Panel ID="panelDOL" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button  key="DOL" title="Ngày tổn thất - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                                        ...
                                        <tr align="center" valign="bottom">
                                            ...
                                            <td rowspan="2">
                                                ...
                                                <asp:Panel ID="panelGhiChuLoaiHinhTonThat" Width="88px"  CssClass="panelUpdate hiden" runat="server">
                                                    ...
                                                    <div style="margin-top:10px">
                                                        <asp:Button  key="GhiChuLoaiHinhTonThat" title="Ghi chú loại hình TT - SR01"  onclick="btnUpdate_Click" Text="Update" runat="server"/>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align:bottom">
                                            ...
                                            <asp:Panel ID="panelDienBienTonThat" Width="802px"  CssClass="panelUpdate hiden" runat="server">
                                                ...
                                                <div style="margin-top:10px">
                                                    <asp:Button key="DienBienTonThat" title="Diễn biến - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                                        ...
                                        <td><asp:Label ID="Label20" runat="server" 
                                            ...
                                            <td>
                                                ...
                                                <asp:Panel ID="panelGhiChuTBCQCN" Width="535px"  CssClass="panelUpdate hiden" runat="server">
                                                    ...
                                                    <div style="margin-top:10px">
                                                        <asp:Button key="GhiChuTBCQCN" title="TBCQCN - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align:bottom" class="style1">
                                            ...
                                            <asp:Panel ID="panelPhamViTonThat" Width="807px" CssClass="panelUpdate hiden" runat="server">
                                                ...
                                                <div style="margin-top:10px">
                                                    <asp:Button key="PhamViTonThat" title="Phạm vi tổn thất - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                            ...
                            <td colspan="3" >
                                ...
                                <div style="float:left; width:58%">
                                    ...
                                    <asp:Panel ID="panelDuPhongTonThat" Width="217px"  CssClass="panelUpdate hiden" runat="server">
                                        ...
                                        <div style="margin-top:10px">
                                            <asp:Button key="DuPhongTonThat" title="Dự phòng TT - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                                ...
                                <div style="float:left; width:42%">
                                   <asp:Label ID="lblPhuLucDinhKemSR01" runat="server" key="PhuLucDinhKemSR01" type="MultiLine" onclick="editField(this)"  Text="Phụ lục ảnh giám định hiện trường." 
                                        ...
                                        <div style="margin-top:10px">
                                            <asp:Button ID="Button25" title="Phụ lục đính kèm - SR01" key="PhuLucDinhKemSR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
            ...
            <div class="body">
                ...
                <div id="content">
                    ...
                    <asp:Panel ID="panelDePhongVaKhuyenCao" Width="99%"  CssClass="panelUpdate hiden" runat="server">
                        ...
                        <div style="margin-top:10px">
                            <asp:Button  key="DePhongVaKhuyenCao" title="Đề phòng và khuyến cáo - SR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                    ...
                    <span class="bg_text" 
                        style=" text-align:center; display:block; width:98%; ">
                        <h3><b>Ý kiến của giám định viên <i>(Loss Adjuster’s Remark)</i></b></h3>
                    </span>
                    ...
                    <span class="field_input" style="padding-left: 20px">
                    ...
                    <asp:Panel ID="panelYKienGDVSR01" Width="99%"  CssClass="panelUpdate hiden" runat="server">
                        ...
                        <div style="margin-top:10px">
                            <asp:Button ID="Button1" title="Ý kiến GĐV - SR01"  key="YKienGDVSR01" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                    ...
                    <asp:Label ID="lblGioKhaoSatHienTruong" runat="server"  key="GioKhaoSatHienTruong" type="SingleLine"  onclick="editField(this)"
                        ...
                        <div style="margin-top:10px">
                            <asp:Button ID="Button22"  title="Giờ Khảo sát HT - SR01"  key="GioKhaoSatHienTruong" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                    ...
                    <asp:Label ID="lblGioKhaoSatHienTruongEN" runat="server" key="GioKhaoSatHienTruongEN"  type="SingleLine" onclick="editField(this)"
                        ...
                        <div style="margin-top:10px">
                            <asp:Button ID="Button23" title="Giờ Khảo sát HT - SR01"  key="GioKhaoSatHienTruongEN" onclick="btnUpdate_Click" Text="Update" runat="server"/>
                  ...
                  <table width="100%">
                    ...
                    <tr>
                        <td width="25%" style="padding-left: 10px" align="center">
                            <asp:Label ID="lblDaiDien1"  key="DaiDien1" type="SingleLine" 
                             ...
                             <asp:Panel ID="panelDaiDien1" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button2" title="Đại diện ký - SR01"   key="DaiDien1" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td width="25%" align="center">
                             ...
                             <asp:Panel ID="panelDaiDien2" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button3" title="Đại diện ký - SR01"  key="DaiDien2" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td width="25%" align="center">                           
                             ...
                             <asp:Panel ID="panelDaiDien3" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button4" title="Đại diện ký - SR01" key="DaiDien3" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td align="center" width="25%">                           
                            <asp:Label ID="lblDaiDien4"  key="DaiDien4" type="SingleLine" 
                             ...
                             <asp:Panel ID="panelDaiDien4" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button5" title="Đại diện ký - SR01" key="DaiDien4" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                    ...
                    <tr>
                        <td width="25%" style="padding-left: 10px" align="center">
                             ...
                             <asp:Panel ID="panelTenDaiDien1" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button6" title="Đại diện ký - SR01"  key="TenDaiDien1" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td align="center" width="25%">                         
                             ...
                             <asp:Panel ID="panelTenDaiDien2" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button7" title="Đại diện ký - SR01"  key="TenDaiDien2" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td align="center" width="25%">
                            <asp:Label ID="lblTenDaiDien3"  key="TenDaiDien3" type="SingleLine" 
                             ...
                             <asp:Panel ID="panelTenDaiDien3" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button8" title="Đại diện ký - SR01" key="TenDaiDien3" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td align="center" width="25%">
                             ...
                             <asp:Panel ID="panelTenDaiDien4" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button9" title="Đại diện ký - SR01" key="TenDaiDien4" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                    ...
                    <tr>
                        <td 
                            style="font-size: 14px; color: #000066; font-style: italic; padding-left: 10px;" 
                            width="25%" align="center">
                            ...
                            <br />
                             ...
                             <asp:Panel ID="panelChucVuDaiDien1" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button10" title="Đại diện ký - SR01" key="ChucVuDaiDien1" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                                        <input  key="ChucVuDaiDien1" type="button" value="Cancel" onclick="cancel(this)" />
                                    </div>
                                </asp:Panel>
                        </td>
                        <td style="font-size: 14px; color: #000066; font-style: italic; padding-left: 10px;" 
                           ...
                           <asp:Label ID="lblChucVuDaiDien2"  key="ChucVuDaiDien2" type="SingleLine" 
                             ...
                             <asp:Panel ID="panelChucVuDaiDien2" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button11" title="Đại diện ký - SR01" key="ChucVuDaiDien2" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td style="font-size: 14px; color: #000066; font-style: italic; padding-left: 10px;" 
                            ...
                            <br />
                             ...
                             <asp:Panel ID="panelChucVuDaiDien3" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button12" title="Đại diện ký - SR01"  key="ChucVuDaiDien3" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
                        ...
                        <td align="center" 
                            ...
                            <asp:Label ID="lblChucVuDaiDien4"  key="ChucVuDaiDien4" type="SingleLine" 
                             ...
                             <asp:Panel ID="panelChucVuDaiDien4" Width="221px" CssClass="panelUpdate hiden" runat="server">
                                    ...
                                    <div style="margin-top:10px">
                                        <asp:Button ID="Button13" title="Đại diện ký - SR01"  key="ChucVuDaiDien4" onclick="btnUpdateDaiDien_Click" Text="Update" runat="server"/>
