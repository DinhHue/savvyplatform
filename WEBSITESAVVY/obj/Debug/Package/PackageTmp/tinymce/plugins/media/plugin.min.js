        ...
        var generalFormItems = [
			{
			    ...
			    items: [
                    {
                        name: 'source1', type: 'filepicker', filetype: 'media', autofocus: true, size: 40,
                        onchange: srcChange
                    },
                    { name: 'open', type: 'button', text: 'Browse...', onclick: browseclick }
				]
			}
		];
                ...
                buttons: [
					{
					    ...
					    onclick: function () {
					        ...
					        var win1 = editor.windowManager.getWindows()[1];
					        // Insert the contents of the dialog.html textarea into the editor
					        var url = win1.getContentWindow().document.getElementById('url').value;
	
					        win.find('#source1').value(url).fire('change');
